...
define('BASE_PATH', "E:/WAMP/www/new/bc_china/archpk/");
define('WEB_PATH', "http://wsbf.net/bc_china/archpk/");
...
if(!isset($_GET['sid'])) {
	...
	while(TRUE) {
		...
		$oldpath = OLD_BASE_PATH.$arr['sID'].$append.".mp3";

		if(file_exists($relpath))
			echo "<tr><td><a href='".WEB_PATH.$arr['sID'].$append.".mp3'>".$arr['sID'].$append.".mp3</a></td></tr>";
		elseif(file_exists($oldpath))
			echo "<tr><td><a href='".OLD_WEB_PATH.$arr['sID'].$append.".mp3'>".$arr['sID'].$append.".mp3</a></td></tr>";
		else break;
		$count++;
		$relpath = BASE_PATH.$arr['sID'].$append.".mp3";
	}
